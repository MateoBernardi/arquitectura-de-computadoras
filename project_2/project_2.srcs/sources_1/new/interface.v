...
// Target Devices: 
// Tool Versions: 
// Description: Pulls opcode/op_A/op_B (3 bytes) from the rx fifo, drives the ALU
//              combinationally, and pushes the result into the tx fifo.
//              Renamed from "interface" -- see note in chat.
// 
// Dependencies: 
// 
// Revision:
